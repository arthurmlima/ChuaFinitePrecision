...
(* CORE_GENERATION_INFO="CCE_2_32_CCE_2_32,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7ev-ffvc1156-2-e,HLS_INPUT_CLOCK=11.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.960000,HLS_SYN_LAT=11790001,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=5874,HLS_SYN_LUT=6844,HLS_VERSION=2023_1}" *)
...
wire   [0:0] or_ln215_fu_540_p2;
reg   [0:0] or_ln215_reg_781;
...
wire   [0:0] or_ln233_fu_600_p2;
reg   [0:0] or_ln233_reg_850;
...
wire   [0:0] or_ln252_fu_660_p2;
reg   [0:0] or_ln252_reg_876;
...
wire   [31:0] bitcast_ln194_fu_443_p1;
wire   [7:0] tmp_fu_446_p4;
wire   [22:0] trunc_ln194_fu_456_p1;
wire   [0:0] icmp_ln194_1_fu_466_p2;
wire   [0:0] icmp_ln194_fu_460_p2;
wire   [0:0] or_ln194_fu_472_p2;
wire   [0:0] and_ln197_fu_484_p2;
wire   [0:0] and_ln194_fu_478_p2;
wire   [31:0] id_3_fu_490_p3;
wire   [31:0] bitcast_ln215_fu_510_p1;
wire   [7:0] tmp_4_fu_514_p4;
wire   [22:0] trunc_ln215_fu_524_p1;
wire   [0:0] icmp_ln215_1_fu_534_p2;
wire   [0:0] icmp_ln215_fu_528_p2;
wire   [0:0] and_ln218_fu_550_p2;
wire   [0:0] and_ln215_fu_546_p2;
wire   [31:0] id_8_fu_554_p3;
wire   [31:0] bitcast_ln233_fu_570_p1;
wire   [7:0] tmp_8_fu_574_p4;
wire   [22:0] trunc_ln233_fu_584_p1;
wire   [0:0] icmp_ln233_1_fu_594_p2;
wire   [0:0] icmp_ln233_fu_588_p2;
wire   [0:0] and_ln236_fu_610_p2;
wire   [0:0] and_ln233_fu_606_p2;
wire   [31:0] id_13_fu_614_p3;
wire   [31:0] bitcast_ln252_fu_630_p1;
wire   [7:0] tmp_2_fu_634_p4;
wire   [22:0] trunc_ln252_fu_644_p1;
wire   [0:0] icmp_ln252_1_fu_654_p2;
wire   [0:0] icmp_ln252_fu_648_p2;
wire   [0:0] and_ln255_fu_670_p2;
wire   [0:0] and_ln252_fu_666_p2;
...
CCE_2_32_faddfsub_32ns_32ns_32_4_full_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
CCE_2_32_fadd_32ns_32ns_32_4_full_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
CCE_2_32_fsub_32ns_32ns_32_4_full_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
CCE_2_32_fmul_32ns_32ns_32_3_max_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 3 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
CCE_2_32_fdiv_32ns_32ns_32_9_no_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 9 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
CCE_2_32_fptrunc_64ns_32_2_no_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 64 ),
    .dout_WIDTH( 32 ))
...
CCE_2_32_fpext_32ns_64_2_no_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 32 ),
    .dout_WIDTH( 64 ))
...
CCE_2_32_fcmp_32ns_32ns_1_2_no_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
CCE_2_32_dadd_64ns_64ns_64_5_full_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
...
CCE_2_32_dmul_64ns_64ns_64_5_max_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_fu_126 <= 17'd0;
    end else if (((regslice_both_output_stream_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln72_fu_410_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state99)) begin
        ...
        or_ln252_reg_876 <= or_ln252_fu_660_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state45)) begin
        or_ln215_reg_781 <= or_ln215_fu_540_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state78)) begin
        or_ln233_reg_850 <= or_ln233_fu_600_p2;
        zd_1_reg_845 <= grp_fu_206_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln72_fu_410_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((regslice_both_output_stream_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln72_fu_410_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state104) | (1'b1 == ap_CS_fsm_state95) | (1'b1 == ap_CS_fsm_state81) | (1'b1 == ap_CS_fsm_state68) | (1'b1 == ap_CS_fsm_state48) | (1'b1 == ap_CS_fsm_state35) | (1'b1 == ap_CS_fsm_state15) | (1'b1 == ap_CS_fsm_state108) | ((regslice_both_output_stream_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln72_fu_410_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
...
assign and_ln194_fu_478_p2 = (or_ln194_fu_472_p2 & grp_fu_218_p2);

assign and_ln197_fu_484_p2 = (or_ln194_fu_472_p2 & grp_fu_223_p2);

assign and_ln215_fu_546_p2 = (tmp_5_reg_787 & or_ln215_reg_781);

assign and_ln218_fu_550_p2 = (tmp_7_reg_792 & or_ln215_reg_781);

assign and_ln233_fu_606_p2 = (tmp_9_reg_856 & or_ln233_reg_850);

assign and_ln236_fu_610_p2 = (tmp_s_reg_861 & or_ln233_reg_850);

assign and_ln252_fu_666_p2 = (tmp_6_reg_887 & or_ln252_reg_876);

assign and_ln255_fu_670_p2 = (tmp_10_reg_892 & or_ln252_reg_876);
...
assign bitcast_ln194_fu_443_p1 = x2_1_fu_122;

assign bitcast_ln215_fu_510_p1 = reg_366;

assign bitcast_ln233_fu_570_p1 = reg_366;

assign bitcast_ln252_fu_630_p1 = reg_274;

assign i_2_fu_416_p2 = (i_fu_126 + 17'd1);

assign icmp_ln194_1_fu_466_p2 = ((trunc_ln194_fu_456_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln194_fu_460_p2 = ((tmp_fu_446_p4 != 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln215_1_fu_534_p2 = ((trunc_ln215_fu_524_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln215_fu_528_p2 = ((tmp_4_fu_514_p4 != 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln233_1_fu_594_p2 = ((trunc_ln233_fu_584_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln233_fu_588_p2 = ((tmp_8_fu_574_p4 != 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln252_1_fu_654_p2 = ((trunc_ln252_fu_644_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln252_fu_648_p2 = ((tmp_2_fu_634_p4 != 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln72_fu_410_p2 = ((i_fu_126 == 17'd90000) ? 1'b1 : 1'b0);

assign id_13_fu_614_p3 = ((and_ln236_fu_610_p2[0:0] == 1'b1) ? grp_fu_171_p2 : grp_fu_180_p2);

assign id_14_fu_622_p3 = ((and_ln233_fu_606_p2[0:0] == 1'b1) ? grp_fu_166_p2 : id_13_fu_614_p3);

assign id_18_fu_674_p3 = ((and_ln255_fu_670_p2[0:0] == 1'b1) ? grp_fu_171_p2 : grp_fu_180_p2);

assign id_19_fu_682_p3 = ((and_ln252_fu_666_p2[0:0] == 1'b1) ? grp_fu_166_p2 : id_18_fu_674_p3);

assign id_3_fu_490_p3 = ((and_ln197_fu_484_p2[0:0] == 1'b1) ? grp_fu_171_p2 : grp_fu_180_p2);

assign id_4_fu_498_p3 = ((and_ln194_fu_478_p2[0:0] == 1'b1) ? grp_fu_166_p2 : id_3_fu_490_p3);

assign id_8_fu_554_p3 = ((and_ln218_fu_550_p2[0:0] == 1'b1) ? grp_fu_171_p2 : grp_fu_180_p2);

assign id_9_fu_562_p3 = ((and_ln215_fu_546_p2[0:0] == 1'b1) ? grp_fu_166_p2 : id_8_fu_554_p3);

assign or_ln194_fu_472_p2 = (icmp_ln194_fu_460_p2 | icmp_ln194_1_fu_466_p2);

assign or_ln215_fu_540_p2 = (icmp_ln215_fu_528_p2 | icmp_ln215_1_fu_534_p2);

assign or_ln233_fu_600_p2 = (icmp_ln233_fu_588_p2 | icmp_ln233_1_fu_594_p2);

assign or_ln252_fu_660_p2 = (icmp_ln252_fu_648_p2 | icmp_ln252_1_fu_654_p2);
...
assign tmp_2_fu_634_p4 = {{bitcast_ln252_fu_630_p1[30:23]}};

assign tmp_4_fu_514_p4 = {{bitcast_ln215_fu_510_p1[30:23]}};

assign tmp_8_fu_574_p4 = {{bitcast_ln233_fu_570_p1[30:23]}};

assign tmp_fu_446_p4 = {{bitcast_ln194_fu_443_p1[30:23]}};

assign trunc_ln194_fu_456_p1 = bitcast_ln194_fu_443_p1[22:0];

assign trunc_ln215_fu_524_p1 = bitcast_ln215_fu_510_p1[22:0];

assign trunc_ln233_fu_584_p1 = bitcast_ln233_fu_570_p1[22:0];

assign trunc_ln252_fu_644_p1 = bitcast_ln252_fu_630_p1[22:0];
...
`include "CCE_2_32_hls_deadlock_kernel_monitor_top.vh"
