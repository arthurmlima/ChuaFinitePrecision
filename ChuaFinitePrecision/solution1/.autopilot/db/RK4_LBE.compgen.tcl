...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 52 \
			corename RK4_LBE_CTRL_axilite \
			name RK4_LBE_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler RK4_LBE_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 60
set RegSliceName RK4_LBE_regslice_both
set RegSliceInstName RK4_LBE_regslice_both_U
set CoreName ap_simcore_RK4_LBE_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
