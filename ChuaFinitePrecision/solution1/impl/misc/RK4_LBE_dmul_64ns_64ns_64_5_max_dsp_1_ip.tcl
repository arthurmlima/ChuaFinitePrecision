...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name RK4_LBE_dmul_64ns_64ns_64_5_max_dsp_1_ip
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Double \
                          ...
                          CONFIG.component_name RK4_LBE_dmul_64ns_64ns_64_5_max_dsp_1_ip \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips RK4_LBE_dmul_64ns_64ns_64_5_max_dsp_1_ip] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files RK4_LBE_dmul_64ns_64ns_64_5_max_dsp_1_ip.xci]
generate_target {synthesis simulation} [get_files RK4_LBE_dmul_64ns_64ns_64_5_max_dsp_1_ip.xci]
