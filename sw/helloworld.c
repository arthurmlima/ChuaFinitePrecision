...
int main(void)
{
	...
	tm_cfg = XRk4_lbe_LookupConfig(XPAR_RK4_LBE_0_DEVICE_ID);
	if (tm_cfg) {
		int status = XRk4_lbe_CfgInitialize(&tm, tm_cfg);
	...
	cmedia.f=0.5007f;
	XRk4_lbe_Set_media(&tm, cmedia.i);
